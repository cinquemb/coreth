...
func (b *Block) Verify() error {
	...
	//if maxBlockTime := uint64(b.vm.clock.Time().Add(maxFutureBlockTime).Unix());
	if maxBlockTime := uint64(aclock.Now().Add(maxFutureBlockTime).Unix()); b.ethBlock.Time() > maxBlockTime {
